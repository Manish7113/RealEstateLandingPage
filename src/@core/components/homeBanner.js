...
export default function HomeBanner() {
    return (
        <div className="m-3 rounded gradientLeftToRight landingPageBanner d-flex justify-content-between align-items-center ">
           
            
            <div className="container row p-0">
                <div className="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 ">
                <div className="ms-5 mt-4 d-flex flex-column align-items-start justify-content-center h-100">
                ...
                <Image src={HomeOne} alt="Not found" width={600} height={600} className="img-fluid"></Image>
